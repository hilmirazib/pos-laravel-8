...
class PembelianDetailController extends Controller
{
    ...
    public function data($id)
    {
        ...
        //     ->of($detail)
        //     ->addIndexColumn()
        //     ->addColumn('nama_produk', fn ($detail) => $detail->produk['nama_produk'])
        //     ->addColumn('kode_produk', fn ($detail) => '<span class="label label-success">' . $detail->produk['kode_produk'] . '</span>')
        //     ->addColumn('harga_beli', fn ($detail) => 'Rp. ' . format_rupiah($detail->harga_beli))
        //     ->addColumn('subtotal', fn ($detail) => 'Rp. ' . format_rupiah($detail->subtotal))
        //     ->addColumn('jumlah', fn ($detail) => '<input type="number" class="form-control input-sm quantity" data-id="' . $detail->id_pembelian_detail . '" value="' . $detail->jumlah . '">')
