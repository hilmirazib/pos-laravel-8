...
class MemberController extends Controller
{
    ...
    public function data()
    {
        ...
        return datatables()
            ->of($member)
            ->addIndexColumn()
            ->addColumn('select_all', fn ($member) => '<input type="checkbox" name="id_member[]" value="' . $member->id_member . '">')
            ->addColumn('kode_member', fn ($member) => '<span class="label label-success">' . $member->kode_member . '<span>')
